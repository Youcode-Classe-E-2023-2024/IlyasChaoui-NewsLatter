...
@section('main')
    @if(Request::url() === 'http://127.0.0.1:8000/dashboard')
        <!-- cards -->
        <x-cards-section :usersCount="$usersCount" :subscribeEmailsCount="$subscribeEmailsCount"/>
        <!-- end cards -->
    @elseif(Request::url() === 'http://127.0.0.1:8000/table')
        <!-- start table -->
        <x-tables :users="$users" :emails="$emails"/>
        <!-- end table -->
    @else
        <!-- start profile -->
...
@section('content')
    ...
    <div fixed-plugin>
        ...
        <div fixed-plugin-card
            ...
            <hr class="h-px mx-0 mysign-1 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent"/>
