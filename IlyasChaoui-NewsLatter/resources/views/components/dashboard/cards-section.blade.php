                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">
                                    All Emails</p>
                                <h5 class="mb-2 font-bold dark:text-white"> {{ $data['counts']['subscribeEmailsCount'] }}</h5>
                                <p class="mb-0 dark:text-white dark:opacity-60">
                                    <span class="text-sm font-bold leading-normal text-emerald-500">+3%</span>
                                    {{ $data['lastInsertionTime']['Email'] }}
                                </p>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">
                                    All medias</p>
                                <h5 class="mb-2 font-bold dark:text-white">{{ $data['counts']['mediaCount'] }}</h5>
                                <p class="mb-0 dark:text-white dark:opacity-60">
                                    <span class="text-sm font-bold leading-normal text-red-600">-2%</span>
                                    {{ $data['lastInsertionTime']['Media'] }}
                                </p>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">
                                    All templates</p>
                                <h5 class="mb-2 font-bold dark:text-white">{{ $data['counts']['templateCount'] }}</h5>
                                <p class="mb-0 dark:text-white dark:opacity-60">
                                    <span class="text-sm font-bold leading-normal text-emerald-500">+5%</span>
                                    {{ $data['lastInsertionTime']['Template'] }}
                                </p>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
