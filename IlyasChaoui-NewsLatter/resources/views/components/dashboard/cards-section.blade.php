                        ...
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">
                                    All Users</p>
                                <h5 class="mb-2 font-bold dark:text-white"> {{ $usersCount }}</h5>
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">
                                    All Emails</p>
                                <h5 class="mb-2 font-bold dark:text-white">{{ $subscribeEmailsCount }}</h5>
                                <p class="mb-0 dark:text-white dark:opacity-60">
            ...
            <div
                ...
                <div class="p-4 pb-0 mb-0 rounded-t-4">
                    <div class="flex justify-between">
                        <h6 class="mb-2 dark:text-white">Last users</h6>
                    </div>
                </div>
