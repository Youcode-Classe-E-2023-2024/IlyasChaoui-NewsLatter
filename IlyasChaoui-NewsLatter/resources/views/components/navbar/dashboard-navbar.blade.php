<nav
    class="relative flex flex-wrap @if(Request::url() === 'http://127.0.0.1:8000/template') bg-blue-500 @endif items-center justify-between px-0 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start"
