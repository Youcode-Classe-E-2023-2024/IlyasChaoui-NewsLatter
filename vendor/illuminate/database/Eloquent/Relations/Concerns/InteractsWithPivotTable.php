...
trait InteractsWithPivotTable
{
    ...
    /**
     * Sync the intermediate table with a list of IDs without detaching.
     *
    ...
    /**
     * Sync the intermediate table with a list of IDs or collection of models.
     *
     * @param  \Illuminate\Support\Collection|\Illuminate\Database\Eloquent\Model|array  $ids
    ...
    /**
     * Sync the intermediate table with a list of IDs or collection of models with the given pivot values.
     *
     * @param  \Illuminate\Support\Collection|\Illuminate\Database\Eloquent\Model|array  $ids
     * @param  array  $values
     * @param  bool  $detaching
