...
class Builder
{
    ...
    /**
     * Get the table that belong to the database.
     *
     * @return array
     */
    ...
    {
        throw new LogicException('This database driver does not support getting all table.');
    }
    ...
    /**
     * Drop all table from the database.
     *
     * @return void
     *
     * @throws \LogicException
    ...
    {
        throw new LogicException('This database driver does not support dropping all table.');
    }
