...
class MySqlGrammar extends Grammar
{
    ...
    {
        return "select * from information_schema.table where table_schema = ? and table_name = ? and table_type = 'BASE TABLE'";
    }
    ...
    public function compileTables($database)
    {
        return sprintf(
            ...
            ."from information_schema.table where table_schema = %s and table_type = 'BASE TABLE' "
            .'order by table_name',
