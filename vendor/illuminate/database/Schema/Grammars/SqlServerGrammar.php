...
class SqlServerGrammar extends Grammar
{
    ...
    /**
     * Compile the query to determine the table.
     *
     * @return string
     */
    ...
    {
        return "select name, type from sys.table where type = 'U'";
    }
    ...
    public function compileIndexes($table)
    {
        return sprintf(
            ...
            .'join sys.table as tbl on idx.object_id = tbl.object_id '
    ...
    public function compileForeignKeys($table)
    {
        return sprintf(
            ...
            .'join sys.table as lt on lt.object_id = fk.parent_object_id '
            ...
            .'join sys.table as ft on ft.object_id = fk.referenced_object_id '
    ...
    /**
     * Compile the SQL needed to drop all table.
     *
     * @return string
     */
