...
class PostgresGrammar extends Grammar
{
    ...
    {
        return "select * from information_schema.table where table_catalog = ? and table_schema = ? and table_name = ? and table_type = 'BASE TABLE'";
    }
    ...
    /**
     * Quote-escape the given table, views, or types.
     *
     * @param  array  $names
     * @return array
     */
